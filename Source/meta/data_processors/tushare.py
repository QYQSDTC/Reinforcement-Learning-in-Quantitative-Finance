...
class ReturnPlotter:
    ...
    def __init__(self, df_account_value, df_trade, start_date, end_date, token):
    ...
    def get_baseline(self, ticket):
        ...
        df = pro.index_daily(ts_code = ticket, start_date=self.start, end_date=self.end)
